<#-- @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/dashlets/my-workspaces.get.head.ftl -->

<#include "../component.head.inc">
<!-- My Sites -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/dashlets/my-workspaces.css" />
<@script type="text/javascript" src="${page.url.context}/res/components/dashlets/my-workspaces.js"></@script>
<!-- Create Site -->
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/modules/create-site.css" />
<@script type="text/javascript" src="${page.url.context}/res/modules/create-site.js"></@script>
<!-- Delete Site -->
