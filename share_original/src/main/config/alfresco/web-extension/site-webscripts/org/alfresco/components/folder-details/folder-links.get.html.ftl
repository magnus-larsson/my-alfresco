...
<#if repositoryUrl??>
   ...
   <div id="${el}-webdav" class="hidden">
      ...
      <div id="${el}-page-url-text" class="url-text" title="${msg("folder-links.webdav.title")}"></div>
   ...
   <div id="${el}-page">
      ...
      <div id="${el}-page-url-text" class="url-text" title="${msg("folder-links.view.title")}"></div>
