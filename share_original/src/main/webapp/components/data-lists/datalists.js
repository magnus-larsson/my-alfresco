...
(function()
{
   ...
   {
      Alfresco.component.DataLists.superclass.constructor.call(this, "Alfresco.component.DataLists", htmlId, ["button", "container","dragdrop"]);
            ...
            else
            {
               ...
               for (var index in lists)
               {
                  if (lists.hasOwnProperty(index))
                  {
                     ...
                     Dom.addClass(el,list.nodeRef); //save it for possible d'n'd move
                     ...
                     if (permissions["edit"])
                     {
                        ...
                        {
                           new DDTarget(el,list.itemType); //dnd group is list type
                        }
                     }
                     else
                     {
