...
Alfresco.service.DataListActions.prototype.onActionMove = function (items,owner) {
   ...
   var msg = function(msgid) { return dataGrid.msg(msgid); };
      ...
      // Load the UI template from the server
		Alfresco.util.Ajax.request(
		{
		   ...
		   successCallback: { fn: function(response) {
                     ...
                     if (items && trgt) {
                        ...
                        Alfresco.util.Ajax.request({
		                     ...
		                     successCallback: {fn: function() { 
		                        popup.hide();
		                        dataGrid.onDataItemsDeleted(null,[null,{ items:items }]);
		                     }, scope: me },
               ...
               // Cancel button
               var cancelButton = Alfresco.util.createYUIButton(this, "cancel", function(){ dialog.hide(); });
...
Alfresco.util.YUILoaderHelper.require(dependencies, function(){}, this);
