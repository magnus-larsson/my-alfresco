...
(function()
{
   ...
   {
      Alfresco.dashlet.PublicSites.superclass.constructor.call(this, "Alfresco.dashlet.PublicSites", htmlId, ["button", "container", "datasource", "datatable", "animation"]);
   ...
   YAHOO.extend(Alfresco.dashlet.PublicSites, Alfresco.component.Base,
   {
       ...
       */
      onCreateSiteLinkClick: function PublicSites_onCreateSiteLinkClick(event)
      {
