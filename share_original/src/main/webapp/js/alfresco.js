...
Alfresco.util.createYUIPanel = function(p_el, p_params, p_custom)
{
   ...
   {
      var pdf = YAHOO.util.Selector.query('div.real object');
      
      if (pdf && (YAHOO.env.ua.ie > 0)) {
         YAHOO.util.Dom.setStyle(pdf, 'visibility', 'hidden');
      }
   ...
   panel.subscribe("hide", function (p_event, p_args)
   {
      ...
      if (pdf && (YAHOO.env.ua.ie > 0)) {
         YAHOO.util.Dom.setStyle(pdf, 'visibility', 'visible');
      }
