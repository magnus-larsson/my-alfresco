...
public class StorageServiceTest {
  ...
  public void setup() throws Exception {
    ...
    globalProperties = m.mock(Properties.class);
    ...
    ssi.setGlobalProperties(globalProperties);
  ...
  public void testPublishBariumDocToStorageFolderExists() {    
    /**
     * Barium number 2, version X -> Lagret/Barium/2/versions/x
     * Barium number 22, version X -> Lagret/Barium/2/2/versions/x
     * Barium number 222, version X -> Lagret/Barium/2/2/2/versions/x
     */
