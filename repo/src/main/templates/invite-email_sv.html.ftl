                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                       <td>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                      Du har blivit inbjuden till platsen '${args["siteName"]}'
                                                   </div>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             har bjudit in dig till platsen <b>${args["siteName"]}</b> med rollen ${args["inviteeSiteRole"]}.</p>
                                             ...
                                             <p>Ett konto har skapats för dig och dina inloggningsuppgifter är:<br />
                           ...
                           <tr>
                              <td style="padding: 0px 30px; font-size: 13px;">
                                 För att få reda på mer on Alfresco ${productName!""} gå till <a href="http://www.vgregion.se/alfresco">http://www.vgregion.se/alfresco</a>
                              </td>
                           </tr>
                           <tr>
                              <td>
