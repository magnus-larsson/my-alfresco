...
function main()
{
   ...
   filterParams = Filters.getFilterParams("path", parsedArgs);
   
   //mod it to check all subfolders if we get recursive=true
   if (args.recursive == 'true') {
      filterParams.query = filterParams.query.replace('/*"','//*"');
   }
