// @overridden projects/remote-api/config/alfresco/templates/webscripts/org/alfresco/repository/upload/upload.post.js
...
function writeContent(contentData, content, tempFilename) {
   if (content) {
      contentData.write(content);
   } else if (tempFilename) {
      serviceUtils.writeContent(contentData, tempFilename);
   }
}
...
function main()
{
   try
   {
      ...
      if (updateNodeRef !== null)
      {
         ...
         writeContent(updateNode.properties.content, content, tempFilename);
      ...
      else
      {
         ...
         if (existingFile !== null)
         {
            ...
            if (existingFile.hasAspect("cm:versionable") && overwrite)
            {
               ...
               writeContent(existingFile.properties.content, content, tempFilename);
