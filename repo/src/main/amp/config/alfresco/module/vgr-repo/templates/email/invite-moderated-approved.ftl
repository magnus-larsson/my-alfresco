                                    ...
                                    <tr>
                                       <td>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div style="font-size: 22px; padding-bottom: 4px;">
                                                      Ansökan om medlemskap till samarbetsytan ${args["siteName"]!""} godkänd
                                                   </div>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             <p>Hej ${args["inviteeFirstName"]!""},</p>
      
                                             <p>${args["inviterFirstName"]!""} ${args["inviterLastName"]!""} 
                                             har accepterat din ansökan om medlemskap till samarbetsytan <b>${args["siteName"]}</b>.</p>
                                             
                                             <p><i>${args["message"]!""}</i></p>
