// @overridden projects/remote-api/config/alfresco/templates/webscripts/org/alfresco/slingshot/documentlibrary/item.lib.ftl
...
<#macro itemJSON item>
   <#escape x as jsonUtils.encodeJSONString(x)>
      ...
      <#local version = "1.0">
      <#if node.hasAspect("cm:versionable") && node.properties["cm:versionLabel"]??><#local version = node.properties["cm:versionLabel"]></#if>
      <#if item.createdBy??>
