...
// @overridden projects/remote-api/config/alfresco/templates/webscripts/org/alfresco/slingshot/search/search.lib.js
...
function getItem(siteId, containerId, pathParts, node, populate)
{
   ...
   if (item) {
      item.pub = Published.isPublished(node);
      item.no_source_and_published = Published.noSourceAndPublished(node);
