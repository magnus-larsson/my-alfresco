...
"documents": [
	...
	"pushedForPublish": <#if document.pushedForPublish??>"${document.pushedForPublish?datetime?string.full}"<#else>""</#if>,
	"pushedForUnpublish": <#if document.pushedForUnpublish??>"${document.pushedForUnpublish?datetime?string.full}"<#else>""</#if>,
