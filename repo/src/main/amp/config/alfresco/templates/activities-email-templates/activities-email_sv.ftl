<#-- @overridden projects/repository/config/alfresco/templates/activities-email-templates/activities-email.ftl -->
<html>
   <head>
      <style type="text/css"><!--
      body
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                           ...
                           <tr>
                              <td style="padding: 0px 30px; font-size: 13px;">
                                 Du kan stänga av notifieringar genom att klicka på denna länken:<br />
