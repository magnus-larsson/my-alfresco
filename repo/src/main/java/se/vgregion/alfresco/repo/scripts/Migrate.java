...
public class Migrate extends DeclarativeWebScript implements InitializingBean {
   ...
   *
   * @param textfile The file to take the metadata from.
   * @param folder   The folder to take the files from.
   * @param limit    The limit to migrate, 0 for all.
   * @param site     The site to migrate to.
  ...
  private Set<VgrDokDocument> migrateArchive(final String archive, final String textfile, final String folder,
    ...
    final Set<VgrDokDocument> migrated = new HashSet<Migrate.VgrDokDocument>();
   ...
   *
   * @param documents The document list to check the names for.
   */
   ...
   *
   * @param versions The Set representing the versions.
   ...
   *
   * @param versions The versions to migrate.
   * @param site     The site to migrate to.
   ...
   *
   * @param document The document to base the search on.
   * @return The NodeRef found or null of none is found.
   * @throws Throws an exception if more than one document is found.
   */
   ...
   *
   * @param nodeRef  The nodeRef to add the document for.
   * @param document The document to read the file info from.
   */
   ...
   *
   * @param workingCopy The working copy to check in.
   * @param versionType Major or minor version.
   * @param madeBy      Made by is used for modifier and creator.
   ...
   *
   * @param baseVersion The base version to check against.
   * @param document    The document representing the next version to check in.
   ...
   * Extracts the "x" part of a "x.y" version label.
   *
   * @param nodeRef         The nodeRef to extract the version from
