...
import static org.alfresco.repo.transaction.RetryingTransactionHelper.RetryingTransactionCallback;

public class AutoDeleteJob implements Job {

  private static final Logger LOG = Logger.getLogger(AutoDeleteJob.class);
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    _transactionService = (TransactionService) context.getJobDetail().getJobDataMap().get("transactionService");
    _fileFolderService = (FileFolderService) context.getJobDetail().getJobDataMap().get("fileFolderService");
  ...
  protected void execute() {
    ...
    RetryingTransactionCallback callback = new RetryingTransactionCallback<Void>() {
      @Override
