package se.vgregion.alfresco.pdfarenditions;
...
public class Index {
  ...
  @Uri(method = HttpMethod.GET, value = { "/vgr/pdfarenditions" }, defaultFormat = "html")
  public Resolution index(WebScriptResponse response) throws IOException {
    return new TemplateResolution(new HashMap<String, Object>());
  }

  @Uri(method = HttpMethod.GET, value = { "/vgr/pdfarenditions/failed" }, defaultFormat = "json")
  ...
  @Uri(method = HttpMethod.PUT, value = { "/vgr/pdfarenditions/failed" }, defaultFormat = "json")
