...
public abstract class AbstractAlfrescoUserGroupServiceHandler implements UserGroupServiceHandler
{
    ...
    /**
     * @see org.alfresco.module.vti.handler.UserGroupServiceHandler#getUserLoginFromEmail(String, java.util.List)
     */
    public List<UserBean> getUserLoginFromEmail(String dwsUrl, List<String> emailList)
    {
        ...
        for (String loginOrEmail : emailList)
        {
            ...
            else
            {
                ...
                {
                    if (loginOrEmail.equals(nodeService.getProperty(personNodeRef, ContentModel.PROP_EMAIL)))
                    {
                        if (logger.isDebugEnabled())
     ...
     * 
     * @param personNodeRef the person node reference ({@link org.alfresco.service.cmr.repository.NodeRef})
     * @return UserBean
     */
