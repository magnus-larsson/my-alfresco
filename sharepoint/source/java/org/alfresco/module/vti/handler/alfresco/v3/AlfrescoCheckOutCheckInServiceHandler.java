...
public class AlfrescoCheckOutCheckInServiceHandler implements CheckOutCheckInServiceHandler
{
  ...
  /**
   * @see org.alfresco.module.vti.handler.CheckOutCheckInServiceHandler#undoCheckOutDocument(String)
   */
  @Override
  ...
  /**
   * @see org.alfresco.module.vti.handler.CheckOutCheckInServiceHandler#checkInDocument(String, String)
   */
  @Override
  ...
  /**
   * @see org.alfresco.module.vti.handler.CheckOutCheckInServiceHandler#checkOutDocument(String)
   */
  @Override
    ...
    NodeRef workingCopy = transactionService.getRetryingTransactionHelper().doInTransaction(new RetryingTransactionCallback<NodeRef>()
      ...
      public NodeRef execute()
      {
        try
        {
          ...
          // NE start patch
          // The document is locked when the checkout is performed below, therefor we need to unlock it. It's locked anyway by the checkout
