...
public class AlfrescoMeetingServiceHandler implements MeetingServiceHandler
{
    ...
    /**
     * @see org.alfresco.module.vti.handler.MeetingServiceHandler#createWorkspace(String, String, int, TimeZoneInformation, org.alfresco.repo.SessionUser)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MeetingServiceHandler#removeMeeting(String, int, String, int, java.util.Date, boolean)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MeetingServiceHandler#deleteWorkspace(String, org.alfresco.repo.SessionUser)
     */
