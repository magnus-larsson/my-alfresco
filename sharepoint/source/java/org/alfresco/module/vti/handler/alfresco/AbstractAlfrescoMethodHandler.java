...
public abstract class AbstractAlfrescoMethodHandler implements MethodHandler
{
     ...
     * 
     * @param transactionService the transaction service to set ({@link org.alfresco.service.transaction.TransactionService})
     */
     ...
     * Set content service
     * 
     * @param contentService the content service to set ({@link org.alfresco.service.cmr.repository.ContentService})
     */
     ...
     * Set node service
     * 
     * @param nodeService the node service to set ({@link org.alfresco.service.cmr.repository.NodeService})
     */
     ...
     * 
     * @param checkOutCheckInService the checkout-checkin service to set ({@link org.alfresco.service.cmr.coci.CheckOutCheckInService})
     */
     ...
     * 
     * @param fileFolderService the file folder service to set ({@link org.alfresco.service.cmr.model.FileFolderService})
     */
     ...
     * 
     * @param permissionService the permission service to set ({@link org.alfresco.service.cmr.security.PermissionService})
     */
     ...
     * 
     * @param authenticationService the authentication service to set ({@link org.alfresco.service.cmr.security.AuthenticationService})
     */
     ...
     * Set version service
     * 
     * @param versionService the version service to set ({@link org.alfresco.service.cmr.version.VersionService})
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#checkInDocument(String, String, String, boolean, java.util.Date, boolean)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#checkOutDocument(String, String, int, int, boolean)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#createDirectory(String, org.alfresco.module.vti.metadata.model.DocMetaInfo)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#getDocsMetaInfo(String, boolean, boolean, boolean, java.util.List)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#getFileOpen(String, String, java.util.List, String,
     *      org.alfresco.module.vti.metadata.dic.VtiSortField, org.alfresco.module.vti.metadata.dic.VtiSort, String)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#moveDocument(String, String, String, java.util.List, java.util.EnumSet, java.util.EnumSet,
     *      boolean, boolean)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#putDocument(String, org.alfresco.module.vti.metadata.model.Document, java.util.EnumSet, String,
     *      boolean, boolean)
     */
    ...
    /**
     * @see org.alfresco.module.vti.handler.MethodHandler#removeDocuments(String, java.util.List, java.util.List, boolean)
     */
     ...
     * 
     * @param fileInfo file info for document, folder or working copy ({@link org.alfresco.service.cmr.model.FileInfo})
     ...
     * 
     * @param fileInfo file info ({@link org.alfresco.service.cmr.model.FileInfo})
     ...
     * 
     * @param documentFileInfo file info for document ({@link org.alfresco.service.cmr.model.FileInfo})
     ...
     * 
     * @param rootFolder relative url on document library folder on site ({@link org.alfresco.service.cmr.model.FileInfo})
     ...
     * 
     * @param fileFileInfo file info ({@link org.alfresco.service.cmr.model.FileInfo})
     ...
     * 
     * @param folderFileInfo file info ({@link org.alfresco.service.cmr.model.FileInfo})
