<#-- @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/documentlibrary/actions-common.get.html.ftl -->
...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/documentlibrary/publish-to-storage-action.css" group="${dependencyGroup}" />
<!--[if lte IE 7]>
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/documentlibrary/publish-to-storage-action-ie.css" group="${dependencyGroup}" />
<![endif]-->

<@script type="text/javascript" src="${url.context}/res/components/documentlibrary/publish-to-storage.js" group="${dependencyGroup}" />

<@script type="text/javascript" src="${url.context}/res/modules/documentlibrary/vgr-copy-move-to.js" group="${dependencyGroup}" />
<@link rel="stylesheet" type="text/css" href="${url.context}/res/modules/documentlibrary/vgr-copy-move-to.css" group="${dependencyGroup}" />

<@link rel="stylesheet" type="text/css" href="${url.context}/res/modules/documentlibrary/vgr-permissions.css" group="${dependencyGroup}" />