<#-- projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/profile/userprofiletoolbar.get.html.ftl -->
...
<div id="${args.htmlid}-body" class="toolbar userprofile">
   ...
   <#-- remove this as VGR does not yet use cloud sync
   <div class="separator">&nbsp;</div>
