...
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/form/controls/ajaxselectone.css" />

<@script type="text/javascript" src="${page.url.context}/res/components/form/controls/selectstatus.js"></@script>
