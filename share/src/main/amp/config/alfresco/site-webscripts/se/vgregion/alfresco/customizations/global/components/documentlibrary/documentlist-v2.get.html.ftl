<#-- @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/documentlibrary/repo.get.html.ftl -->
...
<@markup id="vgr-js" action="after" target="js">
   ...
   <@script type="text/javascript" src="${url.context}/res/components/documentlibrary/publish-to-storage-action.js" group="documentlibrary" />
</@>
