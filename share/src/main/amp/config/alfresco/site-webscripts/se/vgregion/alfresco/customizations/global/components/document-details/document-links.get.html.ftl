...
<@markup id="vgr-css" action="after" target="css">
   <@link rel="stylesheet" type="text/css" href="${url.context}/res/components/document-details/vgr-document-links.css" group="document-details" />
</@>

<@markup id="vgr-js" action="after" target="js">
   <@script type="text/javascript" src="${url.context}/res/components/document-details/vgr-document-links.js" group="document-details" />
</@>
