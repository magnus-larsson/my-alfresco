...
<div class="dashlet my-documents">
   ...
   <div class="toolbar flat-button">
      <div id="${args.htmlid}-filters" class="yui-buttongroup">
         <span id="${args.htmlid}-editing-site" class="yui-button yui-radio-button yui-button-checked">
            <span class="first-child">
               <button type="button" name="${args.htmlid}" value="editingMe">${msg("filter.editing")}</button>
            </span>
         </span>
         <span id="${args.htmlid}-editing-all" class="yui-button yui-radio-button">
            <span class="first-child">
               <button type="button" name="${args.htmlid}" value="editingOthers">${msg("filter.editingOthers")}</button>
            </span>
         </span>
      </div>
   </div>
...
<script type="text/javascript">//<![CDATA[
   ...
   new Alfresco.dashlet.MyDocuments("${args.htmlid}",'${site}','${user}')
