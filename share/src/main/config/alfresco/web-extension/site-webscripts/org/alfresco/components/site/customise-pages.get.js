// @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/site/customise-pages.get.js
...
//is any page set as default page
...
for (var i = 0; i < usedPages.length; i++)
{
   ...
   if (p)
   {
      ...
      pages[pages.length] =
      {
         ...
         defaultPage: usedPage.defaultPage || false,
         used: true
      };
   }
}
...
model.siteId = siteId;
model.pages = pages;
model.defaultPage = defaultPage?defaultPage:'dashboard';
