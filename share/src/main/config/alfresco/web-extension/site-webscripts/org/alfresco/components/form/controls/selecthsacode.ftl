<#-- @overriddden alfresco-vgr-share/src/main/config/alfresco/web-extension/site-webscripts/org/alfresco/components/form/controls/selectmany.ftl -->
   ...
   <#else>
      ...
      <script type="text/javascript">
         ...
         YAHOO.util.Event.onDOMReady(function() {
            var hiddenIdInput = YAHOO.util.Dom.get('${fieldHtmlId}.id'), x, y;
