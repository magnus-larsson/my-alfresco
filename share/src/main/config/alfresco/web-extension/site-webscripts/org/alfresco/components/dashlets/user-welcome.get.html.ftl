<#-- @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/dashlets/user-welcome.get.html.ftl -->
...
<div class="dashlet user-welcome">
   ...
   <div class="body">
      ...
      <div class="detail-list-item">
         ...
         <div><a href="http://intra.vgregion.se/alfresco" class="theme-color-2" target="_blank">På intranätet</a></div>
         <div><a href="http://www.vgregion.se/alfresco" class="theme-color-2" target="_blank">Externt</a></div>
      </div>
      <div class="detail-list-item">
