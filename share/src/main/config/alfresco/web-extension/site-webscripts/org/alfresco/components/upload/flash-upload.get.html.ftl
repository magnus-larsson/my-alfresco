<#-- @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/upload/flash-upload.get.html.ftl -->

<#if !el??>
   <#-- To facilitate including we check before we define el -->
...
<div id="${el}-dialog" class="flash-upload hidden">
   ...
   <div class="bd">
      <div class="browse-wrapper">
         <div class="center">
            <div id="${el}-flashuploader-div">${msg("label.noFlash")}</div>
