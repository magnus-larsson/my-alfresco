// @overridden projects/slingshot/config/alfresco/site-webscripts/org/alfresco/components/documentlibrary/toolbar.get.js
   ...
   if (xmlCreateContent != null)
   {
      for each (var xmlContent in xmlCreateContent.content)
      {
         createContent.push(
         {
            ...
            nodetype: xmlContent.@nodetype.toString()
         });
      }
   }
