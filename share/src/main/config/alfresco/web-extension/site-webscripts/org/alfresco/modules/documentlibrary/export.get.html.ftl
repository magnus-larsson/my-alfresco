...
<div id="${el}-dialog" class="export">
   ...
   <div class="bd">
      <form id="${el}-form" action="" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
         ...
         <div class="yui-gd">
            <div class="yui-u first"><input id="${el}-mets" name="transferFormat" type="radio" value="false" checked="true"/></div>
            <div class="yui-u"><label for="${el}-mets">${msg("label.mets")}</label></div>
         </div>
         <div class="yui-gd">
